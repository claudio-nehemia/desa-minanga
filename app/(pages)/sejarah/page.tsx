    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-teal-600 via-cyan-700 to-blue-800 text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-4 text-white drop-shadow-lg">Sejarah Desa Minanga Dua</h1>
          <p className="text-white/90 text-lg">Menelusuri asal-usul dan perkembangan desa kami</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-cyan-50/30 via-white to-orange-50/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            {/* Origin Section */}
            <div className="relative bg-white rounded-2xl shadow-lg p-8 border-l-4 border-teal-600 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            ...
            {/* Merger Section */}
            <div className="relative bg-white rounded-2xl shadow-lg p-8 border-l-4 border-orange-600 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            ...
            {/* Naming Section */}
            <div className="relative bg-gradient-to-br from-brown-100 via-cream-200 to-brown-50 rounded-2xl p-8 border-l-4 border-brown-800 shadow-xl overflow-hidden">
            ...
            {/* Leadership Section */}
            <div className="relative bg-gradient-to-br from-white via-cream-50 to-white rounded-2xl shadow-xl p-8 border-l-4 border-brown-700 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            ...
            {/* Modern Era Section */}
            <div className="relative bg-gradient-to-br from-white via-cream-50 to-white rounded-2xl shadow-xl p-8 border-l-4 border-cream-700 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            ...
            {/* Timeline */}
            <div className="relative bg-gradient-to-br from-brown-50 via-cream-100 to-brown-50 rounded-2xl p-8 shadow-xl border-2 border-brown-200 overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-brown-200/10 rounded-full filter blur-3xl"></div>
