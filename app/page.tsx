...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-teal-600 via-cyan-700 to-blue-800 text-white py-20 md:py-32 overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-cyan-300 rounded-full filter blur-3xl opacity-50"></div>
        </div>
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center animate-fade-in">
            <div className="inline-block mb-6">
              <span className="bg-white/20 text-white px-6 py-2 rounded-full text-sm font-semibold border border-white/30 backdrop-blur-sm shadow-lg">🏝️ Desa Pesisir Sulawesi Utara</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
              Selamat Datang di Desa Minanga Dua
            </h1>
      ...
      <section className="py-20 relative bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <span className="text-teal-600 font-semibold text-sm uppercase tracking-wider">Informasi Lengkap</span>
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent mt-2 mb-4">
              Jelajahi Informasi Desa
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-teal-500 via-cyan-500 to-orange-500 mx-auto rounded-full"></div>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <Link
                  ...
                  className="group"
                >
                  <div className={`relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full transform hover:scale-105 hover:-translate-y-2 cursor-pointer border-2 ${style.border} overflow-hidden`}>
